            ...
            itemBuilder: (context, index) {
              if (index == 0) {
                ...
                return Padding(
                  ...
                  child: RichText(
                    text: const TextSpan(
                      style: TextStyle(fontSize: 8, color: AppColors.indicatorOrange),
                      children: [
                        TextSpan(text: '说明：', style: TextStyle(fontWeight: FontWeight.w500)),
                        TextSpan(
              ...
              return _IndicatorLightFullCard(light: light);
            },
          ),
        ),
      ),
...
class _IndicatorLightFullCard extends StatelessWidget {
  ...
  const _IndicatorLightFullCard({required this.light});
