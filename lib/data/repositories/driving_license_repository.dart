/// 驾照扣分规则仓库
///
/// 对应 Android: toolCarLib/DrivingLicenseDeductionRulesActivity.kt:190-259
/// getContentForTab(tabIndex)。5 档扣分（记12/9/6/3/1分），纯文本。
class DrivingLicenseRepository {
  /// Tab 标签
  static const tabLabels = ['记12分', '记9分', '记6分', '记3分', '记1分'];

  /// 按 tabIndex 获取扣分规则内容
  String getContent(int tabIndex) {
    switch (tabIndex) {
      case 0:
        return '（一）饮酒后驾驶机动车的；\n\n'
      ...
      case 1:
        return '（一）驾驶7座以上载客汽车载人超过核定人数50%以上未达到100%的；\n\n'
      ...
      case 2:
        return '（一）驾驶校车、公路客运汽车、旅游客运汽车载人超过核定人数未达到20％，或者驾驶7座以上载客汽车载人超过核定人数20%以上未达到50%，或者驾驶其他载客汽车载人超过核定人数50%以上未达到100%的；\n\n'
      ...
      case 3:
        return '（一）驾驶校车、公路客运汽车、旅游客运汽车、7座以上载客汽车以外的其他载客汽车载人超过核定人数20%以上未达到50%的；\n\n'
      ...
      case 4:
        return '（一）驾驶校车、中型以上载客载货汽车、危险物品运输车辆在高速公路、城市快速路以外的道路上行驶超过规定时速10％以上未达到20%的；\n\n'
  ...
  List<String> get tabList => tabLabels;
}
