  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        const _InfoParagraph(title: '交通:', content: ' 从成都乘坐高铁或汽车约1.5小时可到达乐山。乐山市内可乘坐公交车或出租车前往乐山大佛景区。'),
        const SizedBox(height: 12),
        const _InfoParagraph(title: '门票:', content: ' 80元/人'),
        const SizedBox(height: 16),
        const Text(
          '游玩路线',
          style: TextStyle(
        ...
        const _RouteItem(title: '麻浩崖墓:', content: '位于大佛左侧，是汉代崖墓群，具有重要的考古价值。'),
        const _RouteItem(title: '九曲栈道:', content: '沿着栈道下行，可以近距离观赏大佛的雄伟壮观。'),
        const _RouteItem(title: '凌云寺:', content: '位于大佛右侧，是一座历史悠久的佛教寺庙。'),
        const _RouteItem(title: '乌尤寺:', content: '位于大佛对面，可以乘坐游船前往，从江面上欣赏大佛全景。'),
        const SizedBox(height: 10),
        const _TipsSection(tips: [
          '建议早上前往，避开人流高峰。',
          '九曲栈道较为陡峭，注意安全。',
          '可以乘坐游船从江面上欣赏大佛全景。',
        ]),
        ...
        const SizedBox(height: 6),
        const _InfoParagraph(title: '交通:', content: '从乐山乘坐汽车约1小时可到达峨眉山。峨眉山市内可乘坐公交车或出租车前往峨眉山景区。'),
        const _InfoParagraph(title: '门票:', content: '160元/人(旺季)，110元/人(淡季)'),
        const SizedBox(height: 14),
        const Text(
          '游玩路线',
          style: TextStyle(
        ...
        const SizedBox(height: 8),
        const _RouteItem(title: '报国寺:', content: '峨眉山第一大寺，是登山起点。'),
        const _RouteItem(title: '伏虎寺:', content: '寺内供奉着普贤菩萨的坐骑六牙白象。'),
        const _RouteItem(title: '清音阁:', content: '位于牛心岭下，是观赏峨眉山十景之一"双桥清音"的最佳地点。'),
        const _RouteItem(title: '万年寺:', content: '寺内供奉着普贤菩萨的铜像。'),
        const _RouteItem(title: '洗象池:', content: '传说普贤菩萨在此洗象。'),
        const _RouteItem(title: '金顶:', content: '峨眉山主峰，海拔3079米，可观赏云海、日出、佛光等奇观。'),
        const SizedBox(height: 14),
        const _TipsSection(tips: [
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        const _InfoParagraph(title: '乐山:', content: '跷脚牛肉、甜皮鸭、钵钵鸡、豆腐脑、西坝豆腐。'),
        const _InfoParagraph(title: '峨眉山:', content: '峨眉山豆腐、雪魔芋烧鸭、峨眉山腊肉、叶儿粑。'),
        const SizedBox(height: 22),
