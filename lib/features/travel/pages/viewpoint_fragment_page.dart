// 旅行规划主页 - 对齐 master-qingyichuxingqixiang 分支 ViewpointFragmentPage
// （原始对齐 Android ViewpointFragment.kt）
// 背景改为农业页的渐变蓝（#208FEA→#69C4F3），标题白色。
...
class ViewpointFragmentPage extends StatelessWidget {
  ...
  /// 农业页渐变蓝背景 - 与 AgricultureGradientBackground 相同
  static const Color _gradientStart = Color(0xFF208FEA);
  static const Color _gradientEnd = Color(0xFF69C4F3);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: CustomScrollView(
        slivers: [
          // 头部标题栏
          const SliverToBoxAdapter(child: _TravelHeader()),
          // 9 个旅行卡片
          SliverList(
