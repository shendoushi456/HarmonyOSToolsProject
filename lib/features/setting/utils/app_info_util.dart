...
class AppInfoUtil {
  ...
  static const String appName = '气象准点查';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/hmxqzdc/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/hmxqzdc/privacy';
}
