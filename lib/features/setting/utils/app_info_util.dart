...
class AppInfoUtil {
  ...
  static const String appName = '乐彩绘画屋';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjlchhw/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjlchhw/privacy';
}
