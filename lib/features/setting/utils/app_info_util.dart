...
class AppInfoUtil {
  ...
  static const String appName = '瞬变天讯';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjsbtxhm/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjsbtxhm/privacy';
}
