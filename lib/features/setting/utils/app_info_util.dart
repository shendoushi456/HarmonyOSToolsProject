...
class AppInfoUtil {
  ...
  static const String appName = '达速上网通';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjdsswt/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjdsswt/privacy';
}
