...
class AppInfoUtil {
  ...
  static const String appName = '灵感画色堡';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjlghsb/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjlghsb/privacy';
}
