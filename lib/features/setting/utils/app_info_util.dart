...
class AppInfoUtil {
  ...
  static const String appName = '慧扫文档宝';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjhswdb/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjhswdb/privacy';
}
