...
class AppInfoUtil {
  ...
  static const String appName = '智雨云图';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjzyytgm/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjzyytgm/privacy';
}
