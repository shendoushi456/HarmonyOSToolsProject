...
class AppInfoUtil {
  ...
  static const String appName = 'WIFI互联通';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjwfhlt/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjwfhlt/privacy';
}
