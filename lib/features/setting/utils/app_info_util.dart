...
class AppInfoUtil {
  ...
  static const String appName = '晨晓气象站';
...
class SettingUrls {
  ...
  /// 用户协议 URL
  static const String user = 'http://api.jyhytech.top/agreement/bjcxqxzhm/user';

  /// 隐私协议 URL
  static const String policy = 'http://api.jyhytech.top/agreement/bjcxqxzhm/privacy';
}
