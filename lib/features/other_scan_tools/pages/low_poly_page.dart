...
// 生成对齐 StartPolyFun(Dart 版见 low_poly_service);保存改用系统图库(SaveButton 流程)
  ...
  Future<void> _save() async {
    ...
    try {
      await DocumentExportService()
          .exportBytesToGallery(_resultBytes!, name: _imageStamp());
      if (!mounted) return;
      _toast('保存成功');
  ...
  Widget _previewImage() {
    ...
    return Center(
      child: Column(
        ...
        children: [
          Image.asset(AppAssets.otherScanNullImg, width: 98, height: 98),
