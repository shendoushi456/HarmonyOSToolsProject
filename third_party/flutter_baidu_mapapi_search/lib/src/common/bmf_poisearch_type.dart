...
class BMFPoiInfo implements BMFModel {
  ...
  /// POI行政区划代码，设置extensionsAdcode为true时召回
  String? adcode;
...
class BMFPOIDetailInfo implements BMFModel {
  ...
  BMFPOIDetailInfo.fromMap(Map map)
    ...
    tag = map['tag'];
    if (map['facilityRating'] != null) {
      facilityRating = double.parse(map['facilityRating'].toString());
    }
    if (map['tasteRating'] != null) {
      tasteRating = double.parse(map['tasteRating'].toString());
    }
    if (map['overallRating'] != null) {
      overallRating = double.parse(map['overallRating'].toString());
    }
    if (map['serviceRating'] != null) {
      serviceRating = double.parse(map['serviceRating'].toString());
    }
    ...
    type = map['type'];
    if (map['hygieneRating'] != null) {
      hygieneRating = double.parse(map['hygieneRating'].toString());
    }
    naviLocation = map['naviLocation'] == null
        ? null
        : BMFCoordinate.fromMap(map['naviLocation']);
    distance = map['distance'];
    if (map['environmentRating'] != null) {
      environmentRating = double.parse(map['environmentRating'].toString());
    }
    if (map['technologyRating'] != null) {
      technologyRating = double.parse(map['technologyRating'].toString());
    }
