...
class BMFVehicleInfo implements BMFModel {
  ...
  BMFVehicleInfo.fromMap(Map map)
    ...
    uid = map['uid'];
    title = map['title'];
    if (map['passStationNum'] != null) {
      passStationNum = int.parse(map['passStationNum'].toString());
    }
    if (map['totalPrice'] != null) {
      totalPrice = int.parse(map['totalPrice'].toString());
    }
    if (map['zonePrice'] != null) {
      zonePrice = int.parse(map['zonePrice'].toString());
    }
  }
