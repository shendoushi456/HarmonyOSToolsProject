...
class BMFTaxiInfo implements BMFModel {
  ...
  BMFTaxiInfo.fromMap(Map map)
    ...
    if (map['perKMPrice'] != null) {
      perKMPrice = double.parse(map['perKMPrice'].toString());
    }
    if (map['startPrice'] != null) {
      startPrice = double.parse(map['startPrice'].toString());
    }
    if (map['totalPrice'] != null) {
...
class BMFTime implements BMFModel {
  ...
  BMFTime.fromMap(Map map)
    ...
    if (map['dates'] != null) {
      dates = int.parse(map['dates'].toString());
    }
    if (map['hours'] != null) {
      hours = int.parse(map['hours'].toString());
    }
    if (map['minutes'] != null) {
      minutes = int.parse(map['minutes'].toString());
    }
    if (map['seconds'] != null) {
      seconds = int.parse(map['seconds'].toString());
    }
  }
  @override
  fromMap(Map map) {
