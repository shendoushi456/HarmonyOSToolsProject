...
/// poi详情短串分享检索信息类
class BMFPoiDetailShareURLOption extends BMFSearch implements BMFModel {
  /// poi的uid
  String? uid;
  ...
  Map<String, Object?> toMap() {
    return Map.from(super.toMap())..addAll({'uid': this.uid});
  }
}

/// 反geo短串分享检索信息类
class BMFReverseGeoShareURLOption extends BMFSearch implements BMFModel {
  /// 名称
  String? name;
...
/// 路线规划短串分享检索信息类
class BMFRoutePlanShareURLOption extends BMFSearch implements BMFModel {
  /// 路线规划短串分享类型
