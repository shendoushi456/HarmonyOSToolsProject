...
/// 正地理编码参数信息类
class BMFGeoCodeSearchOption extends BMFSearch implements BMFModel {
  /// 待解析的地址。必选。
  ///
  /// 可以输入2种样式的值，分别是：
  ...
  Map<String, Object?> toMap() {
    return Map.from(super.toMap())
      ..addAll({'address': this.address, 'city': this.city});
  }
}

/// 反地理编码参数信息类
class BMFReverseGeoCodeSearchOption extends BMFSearch implements BMFModel {
  /// 待解析的经纬度坐标（必选）
