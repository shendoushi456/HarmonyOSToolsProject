...
/// POI检索过滤条件类
class BMFPoiSearchFilter extends BMFSearch implements BMFModel {
...
/// POI城市检索
class BMFPoiCitySearchOption extends BMFSearch implements BMFModel {
  /// 检索关键字，必选。举例：天安门
  String? keyword;
...
/// POI周边检索
class BMFPoiNearbySearchOption extends BMFSearch implements BMFModel {
  /// 检索关键字，必选。
  ///
...
/// POI矩形区域检索
class BMFPoiBoundSearchOption extends BMFSearch implements BMFModel {
  /// 检索关键字，必选。
  ///
...
/// POI详情检索信息类
class BMFPoiDetailSearchOption extends BMFSearch implements BMFModel {
...
/// 室内POI检索
class BMFPoiIndoorSearchOption extends BMFSearch implements BMFModel {
