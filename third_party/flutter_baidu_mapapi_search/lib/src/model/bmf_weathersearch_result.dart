...
class BMFWeatherSearchResult extends BMFSearch implements BMFModel {
  /// 天气实况数据
...
class BMFWeatherSearchNow implements BMFModel {
  ...
  BMFWeatherSearchNow.fromMap(Map map)
    ...
    clouds = map['clouds'];
    if (map['hourlyPrecipitation'] != null) {
      hourlyPrecipitation = double.parse(map['hourlyPrecipitation'].toString());
    }
    if (map['CO'] != null) {
      CO = double.parse(map['CO'].toString());
    }
...
class BMFWeatherSearchForecastForHours implements BMFModel {
  ...
  BMFWeatherSearchForecastForHours.fromMap(Map map)
    ...
    if (map['hourlyPrecipitation'] != null) {
      try {
        hourlyPrecipitation = int.parse(map['hourlyPrecipitation'].toString());
      } catch (e) {
